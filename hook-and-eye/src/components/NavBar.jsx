...
export function NavBar({ onSearch }) {
    ...
    <ul className="mt-2 mb-4 flex flex-col lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-0">
      ...
      >
        <Button variant="text" className="flex flex-row cursor-pointer items-center p-2 text-sm">
          ...
          <Link to="/newPost" className="flex items-center text-text pl-1">
              New Post
          </Link>          
        </Button>
  ...
  const anonNavList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        <p className="flex items-center text-lg font-semibold text-text">
        ...
        <div className="flex items-center justify-between text-text">
          ...
          <div className="flex items-center flex-1 max-w-md mx-4">
            <form onSubmit={handleSearchSubmit} className="flex items-center flex-1 max-w-md mx-4">
              <div className="relative w-full text-black-500">
                <Input
                  type="search"
                  ...
                  className="!border-text pl-9 placeholder:text-black-500 focus:!border-text placeholder:text-lg"
                  labelProps={{
          ...
          <div className="flex items-center gap-4">
            ...
            {session ? 
              (<div className="flex items-center gap-x-1">
                ...
                size="sm"
                className="hidden lg:inline-block text-base bg-secondary"
                ...
                <div className="flex items-center gap-x-1">
                  <Link to="signIn">
                    <Button
                      variant="text"
                      size="sm"
                      className="hidden lg:inline-block text-base bg-background "
                    >
                      <span>Sign In</span> 
                    </Button>                  
                  </Link>
        ...
        <Collapse open={openNav}>
          ...
          {session ? (
              <div className="flex flex-row  justify-center gap-x-1 max-w-full">
                  <Button fullWidth  size="sm" className="text-sm bg-secondary" onClick={handleSignOut}>
                    <span>Sign Out</span>
                  </Button>            
              </div>
          ) : (
            <div className="flex flex-row  justify-center gap-x-1 max-w-full">
              <Link to="signIn">
                <Button fullWidth variant="text" size="sm" className="text-base bg-background text-text">
                  <span>Sign In</span>
                </Button>            
              </Link>

              <Link to="signUp">
                <Button fullWidth size="sm" className="text-base bg-secondary">
                  <span>Sign Up</span>
                </Button>            
              </Link>
            </div>
