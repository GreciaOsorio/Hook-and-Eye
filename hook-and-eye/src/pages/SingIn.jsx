...
const SignIn = () => {
    ...
    return (
        <div className="p-4 pt-20 min-h-screen flex items-start justify-center text-left text-lg font-bold">
            
            <div className="relative flex flex-col rounded-xl bg-transparent">
                <h4 className="block text-3xl font-semibold text-slate-800">
                    Sign In
                </h4>
                ...
                <form onSubmit={handleSingIn} className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96 ">
                    ...
                    <p className="flex justify-center mt-6 text-slate-600">
                    Don't have an account?
                    <Link to="signUp" className="decoration-solid underline decoration-indigo-500 text-indigo-500 ml-1">Sign Up</Link>
                    </p>
                </form>
            </div>
        </div>
