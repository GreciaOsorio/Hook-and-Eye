        ...
        <div className="whole-page p-4 pt-10 ">
            ...
            <Card className="flex text-left p-3 mt-6 mb-6 w-full bg-primary">
                <CardBody className="p-4">
                    <Link to="/">
                        <svg 
                            ...
                            strokeWidth={1.5} 
                            stroke="currentColor" 
                            className="size-6 flex justify-start text-text">
                    ...
                    {post.user_id === user_id ? (
                        <div className="flex flex-row content-center justify-end gap-3">
                            <Link to={"edit/" + post.id}>
                                    ...
                                    strokeWidth={1.5} 
                                    stroke="currentColor" 
                                    className="size-6 cursor-pointer text-text">
                    ...
                    <Typography className="font-medium text-lg text-text">
                        {post.content}
                    </Typography >
                    {post.file || post.url ? (
                        <img 
                        ...
                        alt="post-image"
                        className="h-1/2 w-3/4 object-contain mx-auto pt-4"
                        />
                    ):
                    (
                        <div></div>
                ...
                <CardFooter className="pt-0 pb-1">
                    <Button variant="text" 
                            className=" flex flex-row cursor-pointer items-center pl-1 text-sm text-text"
                            onClick={updateLike}
                            disabled={isUpdating}
